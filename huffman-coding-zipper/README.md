...
I have  use **Huffman's algorithm** to construct **a tree** that is used for data compression. 
I have assumed that each character has an associated weight equal to the number of times the character occurs in a file,
When compressing a file i will need to calculate these weights.
...
Finally, I added a **pseudo EOF character**, and I chose it out of the ASCII table in the human readable range so I am not limiting the user to not use any ASCII characters.
